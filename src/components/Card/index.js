...
export const SCard = ({ source, alt }) => {
  return (
    <div className="lg:w-[90%] w-[250px] mt-[80px] mb-5 flex items-center flex-col drop-shadow-2xl shadow-2xl ml-auto mr-auto bg-white backdrop-blur-3xl drop-shadow-3xl py-0 px-0 rounded-lg h-[400px] lg:h-[430px]">
      <img
        className="lg:w-[98%] w-42 lg:mt-20 mt-6 mb-3 mr-auto ml-auto rounded-2xl h-42 lg:h-[98%]"
        src={source}
        alt={alt}
      />
    </div>
...
export const DestinationCard = ({ source, alt, text }) => {
    return (
